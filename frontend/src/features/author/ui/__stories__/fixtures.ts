...
export const SMUS_ASSETS: SmusAsset[] = [
  {
    ...
    projectId: 'prj-1',
    projectName: 'datahub_prod',
    url: 'https://example.invalid/catalog/assets/lst-sales-gold',
    table: { catalog: 'AwsDataCatalog', database: 'contract_sales', name: 'sales_gold' },
  ...
  },
  {
    ...
    projectId: 'prj-1',
    projectName: 'datahub_prod',
    table: { database: 'contract_sales', name: 'customer_dim' },
    columns: [
  ...
  },
  {
    ...
    assetType: 'amazon.datazone.GlueTableAssetType',
    projectId: 'prj-2',
    projectName: 'datahub_dev',
    table: { database: 'contract_finance', name: 'revenue_targets' },
