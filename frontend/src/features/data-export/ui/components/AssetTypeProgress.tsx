import { CheckCircle, Error, ExpandLess, ExpandMore, HourglassEmpty } from '@mui/icons-material';
import {
  alpha,
  Box,
  Card,
...
import type { AssetTypeProgressState } from '../../model/types';
...
function AssetTypeProgressCard({ assetType, progress }: AssetTypeProgressCardProps) {
  ...
  const progressPercentage =
    progress.total > 0 ? ((progress.enriched || 0) / progress.total) * 100 : 0;
