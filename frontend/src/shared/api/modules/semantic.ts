...
export const semanticApi = {
  ...
  getTerm: (termId: string) => apiClient.get(`/semantic/terms/${termId}`).then((res) => res.data),
  createTerm: (term: any) => apiClient.post('/semantic/terms', term).then((res) => res.data),
  ...
  // Categories
  getCategories: () => apiClient.get('/semantic/categories').then((res) => res.data),
  ...
  // Unmapped fields
  getUnmappedFields: () => apiClient.get('/semantic/unmapped').then((res) => res.data),

  // Stats
  getStats: () => apiClient.get('/semantic/stats').then((res) => res.data),

  // Import/Export
  importTerms: (terms: any[]) =>
    apiClient.post('/semantic/terms/import', { terms }).then((res) => res.data),
  exportTerms: () => apiClient.get('/semantic/terms/export').then((res) => res.data),
};
