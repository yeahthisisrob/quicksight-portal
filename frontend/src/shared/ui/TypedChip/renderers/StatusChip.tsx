...
export const StatusChip = React.forwardRef<HTMLDivElement, StatusChipProps>(
  ({ Icon, label, effectiveVariant, size, showIcon, ...chipProps }, ref) => {
    return (
      <Chip
        ref={ref}
        size={size}
        ...
        sx={{
          backgroundColor:
            effectiveVariant === 'filled' ? colors.neutral[400] : colors.neutral[100],
          ...
          '&:hover': chipProps.onClick
            ? {
                backgroundColor:
                  effectiveVariant === 'filled' ? colors.neutral[500] : colors.neutral[200],
              }
            : {},
          ...chipProps.sx,
        }}
