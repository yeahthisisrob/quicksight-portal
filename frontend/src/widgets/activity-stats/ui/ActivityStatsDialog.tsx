...
import { colors, spacing, typography } from '@/shared/design-system/theme';
...
export function ActivityStatsDialog({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
      <DialogTitle>Activity Statistics - {assetName}</DialogTitle>
                ...
                <Table size="small">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="right" sx={{ width: '15%', minWidth: 80 }}>
                        Views
                      </TableCell>
                      <TableCell align="right" sx={{ width: '25%', minWidth: 180 }}>
                        Last Viewed
                      </TableCell>
                    </TableRow>
                  </TableHead>
                        ...
                        <TableCell>
                          {viewer.groups && viewer.groups.length > 0 ? (
                            ...
                            >
                              <Chip
                                label={
                                  viewer.groups.length === 1
                                    ? viewer.groups[0]
                                    : `${viewer.groups[0]} +${viewer.groups.length - 1}`
                                }
                                size="small"
                                color="default"
                                sx={{
