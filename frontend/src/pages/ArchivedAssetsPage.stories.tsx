...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A page for viewing and managing archived QuickSight assets. Shows all deleted assets across all asset types with archive metadata including when and why they were archived.',
      },
    },
  },
  decorators: [
...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'The default archived assets page showing all archived assets with server-side pagination and filtering.',
      },
    },
  },
};
...
export const FilteredByType: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Archived assets page with asset type filter applied, showing only specific asset types.',
      },
    },
  },
};
...
export const WithSearch: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Archived assets page with active search, demonstrating the search functionality across asset names, IDs, and archive reasons.',
      },
    },
  },
};
