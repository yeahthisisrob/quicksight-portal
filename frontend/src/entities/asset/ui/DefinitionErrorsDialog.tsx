    ...
    >
      ...
      <DialogContent sx={{ pt: 2 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          The following errors were found in the {assetType} definition. These may prevent the{' '}
          {assetType} from functioning correctly.
        </Typography>
                ...
                <div key={idx}>
                  <ListItem sx={{ alignItems: 'flex-start', py: 2 }}>
                    <ListItemText
                      ...
                      secondary={
                        error.violatedEntities &&
                        error.violatedEntities.length > 0 && (
                          <Box sx={{ mt: 1 }}>
                            <Typography
                              variant="caption"
