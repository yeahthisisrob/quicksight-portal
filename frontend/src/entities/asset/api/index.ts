...
export const assetApi = {
  ...
  list: (type: AssetType) => api.get(`/assets/${type}`),

  // Get asset details
  getById: (type: AssetType, id: string) => api.get(`/assets/${type}/${id}`),

  // Get asset metadata from S3
  getMetadata: (type: AssetType, id: string) => api.get(`/assets/${type}/${id}/metadata`),
  ...
  // Get related assets
  getRelatedAssets: (type: AssetType, id: string) => api.get(`/assets/${type}/${id}/related`),
