...
const ASSET_CONFIGS: Record<string, AssetTypeConfig> = {
  dashboards: {
    key: 'dashboards',
    apiMethod: (params: FetchParams) => assetsApi.getDashboardsPaginated(params),
    dataKey: 'dashboards',
    queryKey: 'dashboards-paginated',
  },
  datasets: {
    key: 'datasets',
    apiMethod: (params: FetchParams) => assetsApi.getDatasetsPaginated(params),
    dataKey: 'datasets',
    queryKey: 'datasets-paginated',
  },
  analyses: {
    key: 'analyses',
    apiMethod: (params: FetchParams) => assetsApi.getAnalysesPaginated(params),
    dataKey: 'analyses',
    queryKey: 'analyses-paginated',
  },
  datasources: {
    key: 'datasources',
    apiMethod: (params: FetchParams) => assetsApi.getDatasourcesPaginated(params),
    dataKey: 'datasources',
    queryKey: 'datasources-paginated',
  },
  folders: {
    key: 'folders',
    apiMethod: (params: FetchParams) => assetsApi.getFoldersPaginated(params),
    dataKey: 'folders',
    queryKey: 'folders-list',
  },
  users: {
    key: 'users',
    apiMethod: (params: FetchParams) => assetsApi.getUsersPaginated(params),
    dataKey: 'users',
    queryKey: 'users-list',
  },
  groups: {
    key: 'groups',
    apiMethod: (params: FetchParams) => assetsApi.getGroupsPaginated(params),
    dataKey: 'groups',
    queryKey: 'groups',
  },
};
