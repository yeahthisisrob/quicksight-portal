...
export const folderApi = {
  ...
  // Get folder details
  getById: (folderId: string) => api.get(`/folders/${folderId}`),

  // Get folder members
  getMembers: (folderId: string) => api.get(`/folders/${folderId}/members`),
  ...
  // Create folder
  create: (folder: Partial<Folder>) => api.post('/folders', folder),

  // Update folder
  update: (folderId: string, updates: Partial<Folder>) => api.put(`/folders/${folderId}`, updates),
