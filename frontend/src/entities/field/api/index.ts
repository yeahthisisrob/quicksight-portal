...
export const fieldApi = {
  ...
  getCatalog: () => api.get('/data-catalog'),

  // Get field details
  getFieldDetails: (fieldId: string) => api.get(`/data-catalog/fields/${fieldId}`),

  // Get field usage across assets
  getFieldUsage: (fieldId: string) => api.get(`/data-catalog/fields/${fieldId}/usage`),

  // Get calculated fields
  getCalculatedFields: () => api.get('/data-catalog/calculated-fields'),
  ...
  // Rebuild catalog
  rebuildCatalog: () => api.post('/data-catalog/rebuild'),
};
