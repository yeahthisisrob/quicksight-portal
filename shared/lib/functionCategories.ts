...
export const functionCategories: {
  ...
  DISTINCT_COUNT_IF: {
    standardFunction: 'distinct_countIf',
  ...
  PERIOD_TO_DATE_AVG: {
    standardFunction: 'periodToDateAvg',
    category: 'Aggregate Functions',
    cost: 9,
  },
  PERIOD_TO_DATE_COUNT: {
    standardFunction: 'periodToDateCount',
    category: 'Aggregate Functions',
    cost: 8,
  },
  PERIOD_TO_DATE_MAX: {
    standardFunction: 'periodToDateMax',
    category: 'Aggregate Functions',
    cost: 8,
  },
  PERIOD_TO_DATE_MEDIAN: {
    standardFunction: 'periodToDateMedian',
    category: 'Aggregate Functions',
    cost: 9,
  },
  PERIOD_TO_DATE_MIN: {
    standardFunction: 'periodToDateMin',
    category: 'Aggregate Functions',
    cost: 8,
  },
  PERIOD_TO_DATE_PERCENTILE: {
    standardFunction: 'periodToDatePercentile',
    category: 'Aggregate Functions',
    cost: 10,
  },
  PERIOD_TO_DATE_PERCENTILE_CONT: {
    standardFunction: 'periodToDatePercentileCont',
    category: 'Aggregate Functions',
    cost: 10,
  },
  PERIOD_TO_DATE_STDEV: {
    standardFunction: 'periodToDateStDev',
    category: 'Aggregate Functions',
    cost: 9,
  },
  PERIOD_TO_DATE_STDEVP: {
    standardFunction: 'periodToDateStDevP',
    category: 'Aggregate Functions',
    cost: 9,
  },
  PERIOD_TO_DATE_SUM: {
    standardFunction: 'periodToDateSum',
    category: 'Aggregate Functions',
    cost: 8,
  },
  PERIOD_TO_DATE_VAR: {
    standardFunction: 'periodToDateVar',
    category: 'Aggregate Functions',
    cost: 9,
  },
  PERIOD_TO_DATE_VARP: {
    standardFunction: 'periodToDateVarP',
    category: 'Aggregate Functions',
    cost: 9,
  },
  ...
  DISTINCT_COUNT_LACA: {
    standardFunction: 'distinctCount',
    category: 'Aggregate Functions',
    cost: 12,
    isLAC: true,
  },
  ...
  PERCENTILE_DISC_LACA: {
    standardFunction: 'percentileDisc',
    category: 'Aggregate Functions',
    cost: 7,
    isLAC: true,
  },
  PERCENTILE_CONT_LACA: {
    standardFunction: 'percentileCont',
    category: 'Aggregate Functions',
    cost: 7,
    isLAC: true,
  },
  ...
  DISTINCTCOUNTOVER: {
    standardFunction: 'distinctCountOver',
  ...
  PERCENTILERANK: {
    standardFunction: 'percentileRank',
    category: 'Table Calculation Functions',
    cost: 9,
  },
...
export const getFunctionCategoryAndCost = (func: string): { category: string; cost: number } => {
  const functionName = (func.split('(')[0] ?? '').toUpperCase(); // Ensure case insensitivity
  const lowerCaseCategories = Object.entries(functionCategories).reduce(
    (acc, [key, value]) => {
